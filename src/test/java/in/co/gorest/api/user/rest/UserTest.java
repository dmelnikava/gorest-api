...
public class UserTest extends BaseGorestApiTest {
    ...
    public void verifyGetUserInfoByIdTest() {
        ...
        User expectedUser = usersPage.getRandomUser();
        QueryParameter userIdParam = new QueryParameter(QueryParameter.QueryOption.ID, expectedUser.getId());
        ...
        Response responseUserData = makeRequest(EndpointTypes.USERS.getAllRequest());
    ...
    public void verifyPostUserInfoTest() {
        ...
        Specification.setOption(URL, expectedUser, StatusCodes.CREATED);
        Response responseUserData = makeRequest(EndpointTypes.USERS.postRequest());
    ...
    public void verifyPostUserWithMissingFieldTest() {
        ...
        Specification.setOption(URL, user, StatusCodes.UNPROCESSABLE_ENTITY);
        Response responseData = makeRequest(EndpointTypes.USERS.postRequest());
    ...
    public void verifyDeleteUserInfoTest() {
        UsersPage usersPage = new UsersPage(getDriver());
        User user = usersPage.getRandomUser();
        Specification.setOption(URL, StatusCodes.NO_CONTENT);
        Pair<RequestTypes, String> deleteRequest = EndpointTypes.USERS.deleteRequest();
        Pair<RequestTypes, String> deleteUserEndpoint = Pair.of(deleteRequest.getKey(), String.format(deleteRequest.getValue(), user.getId()));
        ...
        Specification.setOption(URL, StatusCodes.NOT_FOUND);
        Pair<RequestTypes, String> getRequest = EndpointTypes.USERS.getOneRequest();
        Pair<RequestTypes, String> getUserEndpoint = Pair.of(getRequest.getKey(), String.format(getRequest.getValue(), user.getId()));
    ...
    public void verifyPutUserInfoTest() {
        ...
        Specification.setOption(URL, newUserEmail, StatusCodes.OK);
        Pair<RequestTypes, String> putRequest = EndpointTypes.USERS.putRequest();
        Pair<RequestTypes, String> putUserInfoEndpoint = Pair.of(putRequest.getKey(), String.format(putRequest.getValue(), user.getId()));
    ...
    public void verifyPatchUserInfoTest() {
        ...
        Specification.setOption(URL, newUserName, StatusCodes.OK);
        Pair<RequestTypes, String> patchRequest = EndpointTypes.USERS.patchRequest();
        Pair<RequestTypes, String> patchUserInfoEndpoint = Pair.of(patchRequest.getKey(), String.format(patchRequest.getValue(), user.getId()));
